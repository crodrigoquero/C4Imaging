        ...
        private Task<bool> ProcessFileAsync(string filePath)
        {
            ...
            try
            {
                ...
                foreach (ImageCategorizationResult imgCategoryzationResult in imgCategoryzationResults)
                {
                    ...
                    _logger.LogInformation("AN IMAGE HAS BEEN CATEGORIZED BY YEAR TAKEN: " + Path.GetFileName(filePath) + " WAS TAKEN ON " + imgCategoryzationResult.ImageCategory, imgCategoryzationResult.LogId);
                }
