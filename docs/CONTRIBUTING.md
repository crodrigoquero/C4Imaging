...
- A generic description about the workflow.
...
Enhancement suggestions are tracked as discussions. After you've determined which project your enhancement suggestion is related to, create an discussion entry on that project and provide the following information:
...
You have an idea that is complex but at the same time infeasible, unstructured... If that is the case, please have a look on the [Wishful thinking?](/../../C4Imaging/discussions/55) discussion.
