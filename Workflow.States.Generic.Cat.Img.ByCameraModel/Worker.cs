    ...
    public class Worker : BackgroundService
    {
        ...
        private Task<bool> ProcessFileAsync(string filePath)
        {
            ...
            try
            {
                ...
                imgCategoryzationResults = GetImageCameraModel(filePath);
                ...
                foreach (ImageCategorizationResult imgCategoryzationResult in imgCategoryzationResults)
                {
                    ...
                    _logger.LogInformation("AN IMAGE HAS BEEN CATEGORIZED BY CAMERA MODEL: " + Path.GetFileName(filePath) + " HAS A RESOLUTION OF " + imgCategoryzationResult.ImageCategory, imgCategoryzationResult.LogId);
                }
