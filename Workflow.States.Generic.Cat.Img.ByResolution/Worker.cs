...
namespace Workflow.States.Generic.Cat.Img.ByResolution
{
    public class Worker : BackgroundService
    {
        ...
        private Task<bool> ProcessFileAsync(string filePath)
        {
            ...
            try
            {
                ...
                imgCategoryzationResults = GetImageResolution(filePath);
                ...
                foreach (ImageCategorizationResult imgCategoryzationResult in imgCategoryzationResults)
                {
                    ...
                    _logger.LogInformation("AN IMAGE HAS BEEN CATEGORIZED BY RESOLUTION: " + Path.GetFileName(filePath) + " HAS A RESOLUTION OF " + imgCategoryzationResult.ImageCategory, imgCategoryzationResult.LogId);
                }
