    ...
    public class Worker : BackgroundService
    {
        ...
        private Task<bool> ProcessFileAsync(string filePath)
        {
            ...
            try
            {
                ...
                imgCategoryzationResults = GetImageSeasonTaken(filePath);
                ...
                foreach (ImageCategorizationResult imgCategoryzationResult in imgCategoryzationResults)
                {
                    ...
                    _logger.LogInformation("AN IMAGE HAS BEEN CATEGORIZED BY SEASON: " + Path.GetFileName(filePath) + " WAS TAKEN ON " + imgCategoryzationResult.ImageCategory, imgCategoryzationResult.LogId);
