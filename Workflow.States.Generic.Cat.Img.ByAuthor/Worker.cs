        ...
        private Task<bool> ProcessFileAsync(string filePath)
        {
            ...
            try
            {
                ...
                foreach (ImageCategorizationResult imgCategoryzationResult in imgCategoryzationResults)
                {
                    ...
                    _logger.LogInformation("AN IMAGE HAS BEEN CATEGORIZED BY AUTHOR: " + Path.GetFileName(filePath) + " WAS TAKEN BY " + imgCategoryzationResult.ImageCategory, imgCategoryzationResult.LogId);
