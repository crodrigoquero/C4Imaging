    ...
    public class Worker : BackgroundService
    {
        ...
        private Task<bool> ProcessFileAsync(string filePath)
        {
            ...
            try
            {
                ...
                imgCategoryzationResults = GetImageMonthNameTaken(filePath);
                ...
                foreach (ImageCategorizationResult imgCategoryzationResult in imgCategoryzationResults)
                {
                    ...
                    _logger.LogInformation("AN IMAGE HAS BEEN CATEGORIZED BY MONTH TAKEN: " + Path.GetFileName(filePath) + " WAS TAKEN ON " + imgCategoryzationResult.ImageCategory, imgCategoryzationResult.LogId);
                }
